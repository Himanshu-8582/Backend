...
const updateUserCoverImage = asyncHandler(async (req, res) => { 
    ...
    return res.status(200).json(new ApiResponse(200, 'User coverImage updated successfully', user));
});
...
const getUserChannelProfile = asyncHandler(async (req, res) => { 
    ...
    // aggregation to get user profile along with subscribers and subscribed channels ( aggregation framework/pipeline )
...
const getWatchHistory = asyncHandler(async (req, res) => { 
    ...
    return res.status(200).json(new ApiResponse(200, 'User watch history fetched successfully', user[0].watchHistory));
});
